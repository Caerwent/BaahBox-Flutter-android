...
import 'package:baahbox/model/GameInput.dart';
  ...
  void startGame() {
    if (!appController.isConnectedToBox) {
      ...
      gameInput = GameInput(
          ...
          directionType: settingsController.mazeSettings["isFineDirection"]
              ? GameInputDirectionType.analogic
              : GameInputDirectionType.digital);
    }
