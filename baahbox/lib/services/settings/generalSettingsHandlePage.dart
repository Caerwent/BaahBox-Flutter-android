  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child:
              ...
              child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Sélectionnez l\'amplitude de mouvement à détecter (en degré de rotation).',
                          style: TextStyle(
                            fontSize: 12,
                          ),
                        ),
          ...
          RotationSlider(isLower: true, min: 0, max: 90),
          const SizedBox(
            height: 12,
          ),
          Obx(() => Text(
          ...
          RotationSlider(isLower: false, min: 90, max: 180),
        ]));
  }
}
